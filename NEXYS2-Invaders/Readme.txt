...
Build:
* Obtain correct roms file for space invaders, see roms folder readme for correct rom file names.
* Unzip rom files to the roms folder.
* Run the make_invaders_proms script in the scripts folder.
* Copy the script generated prom files to the proms folder.
* Open the Invaders project file using Xilinx 11.1 webpack or similar and compile.
